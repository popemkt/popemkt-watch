...
```text
 system tile host ──► AgendaTileService.onTileRequest(req)
                         ...
                         2. read agenda window from CalendarSource (now−AGENDA_LOOKBACK … now+AGENDA_FORWARD)
